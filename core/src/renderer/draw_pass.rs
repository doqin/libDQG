...
pub struct DrawPass<'a> {
    ...
    pub(crate) world_sprite_outline_pipeline: &'a wgpu::RenderPipeline,
    pub(crate) model_pipeline: &'a wgpu::RenderPipeline,
    pub(crate) model_outline_pipeline: &'a wgpu::RenderPipeline,
